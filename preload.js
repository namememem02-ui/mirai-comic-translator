...
contextBridge.exposeInMainWorld('api', {
  ...
  translateCrop: (args) => ipcRenderer.invoke('translate-crop', args),
  ...
  deletePage: (args) => ipcRenderer.invoke('delete-page', args),
  listChapterTranslations: (args) => ipcRenderer.invoke('list-chapter-translations', args),
  addCreditPage: (args) => ipcRenderer.invoke('add-credit-page', args),
  addCoverPage: (args) => ipcRenderer.invoke('add-cover-page', args),
