...
function createInpaintSidecarManager(options = {}) {
  ...
  const sidecarPath = launchDescriptor?.serverPath || options.sidecarPath || path.join(projectRoot, 'sidecar', 'inpaint_server.py');
  ...
  async function start() {
    ...
    const spawnEnv = {
      LAMA_BACKEND: launchDescriptor?.backend || 'cpu',
