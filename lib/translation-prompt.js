function buildTranslationPrompt(glossary = {}) {
  ...
  return `You are a professional manga/comic translator and layout analyst. ` +
    ...
    `5. Put only newly discovered character-name mappings in discovered_names.\n` +
    `6. Output ONLY a valid JSON array, containing objects with keys: "bubble_id", "box_2d", "original_text", and "translated_text". Do not wrap in markdown tags like \`\`\`json.\n\n` +
